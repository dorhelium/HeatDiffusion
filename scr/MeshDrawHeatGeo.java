...
public class MeshDrawHeatGeo {
	...
	//and to set the value with the IntParameter shininess value 
	//using an appropriate glUniform call to interactively adjust the shininess of the GLSL rendering. 
	...
	private int uSpecularShininessID;
	...
	public void init( GL2 gl ) {
    	...
    	uSpecularShininessID = state.getUniformLocation(gl, "specularShininess");
    ...
    public void drawVBOs( GL2 gl ) {
        ...
        int shinVal = shininess.getValue();
		...
		gl.glUniform1i(uSpecularShininessID, shinVal);
